<nav class="navbarlocation">
    <a class="navbarstyle <?php if($page == 'index'){echo 'active';} ?>" href="/apo_leon/index">Home</a>
    <a class="navbarstyle <?php if($page == 'service'){echo 'active';} ?>" href="/apo_leon/pages/service">Services</a>
